 ...
 return (
  ...
  >
   ...
   {isSuccessfullRequest && (
    <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="toast">
   ...
   <div className="sm:flex-row flex-row flex items-center justify-between w-full gap-4 flex-wrap">
    <motion.a
     whileHover={{ opacity: 0.7 }}
     whileTap={{ scale: 0.9 }}
     ...
     target="_blank"
     className={
      "flex sm:py-2 flex-row items-center justify-center gap-4 border-gray100 box-border bg-transparent border-[1px] w-full p-4 rounded-md min-w-0 flex-1"
     }
    >
    ...
    <motion.a
     whileHover={{ opacity: 0.7 }}
     whileTap={{ scale: 0.9 }}
     href="https://wa.me/5543988668668"
     target="_blank"
     className={
      "flex sm:py-2 flex-row items-center justify-center gap-4 border-gray100 box-border bg-transparent border-[1px] w-full p-4 rounded-md min-w-0 flex-1"
     }
    >
     ...
     <p className="sm:hidden text-white font-bold">WHATSAPP</p>
    </motion.a>
    <motion.a
     whileHover={{ opacity: 0.7 }}
     whileTap={{ scale: 0.9 }}
